...
// // UserAvatar removed to match the specific layout
...
//         if (res?.success) {
//           // ✅ Filtering Logic: Only Astrology (Subcategory check removed to show all news)
//           const astroNews = res.data.filter((item) => {
//             const categoryName = item.category?.name?.toLowerCase() || "";
//             // केवल कैटेगरी चेक करें (Subcategory की शर्त हटा दी है ताकि न्यूज़ दिखे)
...
//         <p className="mt-2">Astrology समाचार लोड हो रहे हैं...</p>
//       </div>
//     );
//   }
...
//       {/* ✅ Header (अब यह कोड में सिर्फ एक बार है) */}
...
//             className="me-2"
//           ></div>
//           <h5 className="fw-bold m-0">Astrology</h5>
//         </div>
//         <hr
...
//       {/* ✅ Content Logic: अगर न्यूज़ नहीं है तो Alert, वरना News Layout */}
//       {newsData.length === 0 ? (
