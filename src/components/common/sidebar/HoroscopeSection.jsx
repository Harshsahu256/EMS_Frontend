...
// // ✅ NEW: English Sign to Phonetic Mapping (based on your API response)
...
//   const [isLoading, setIsLoading] = useState(true);
//   const [error, setError] = useState(null);
//   // ✅ भाषा को मैनेज करने के लिए स्टेट जोड़ें
...
//           const lowerPhoneticSign = signPhoneticMapping[selectedSign].toLowerCase(); // ✅ NEW: Get phonetic name
...
//               title.includes(lowerHindiSign) ||
//               title.includes(lowerEnglishSign) ||
//               title.includes(lowerPhoneticSign) || // ✅ NEW: Check phonetic in title
//               summary.includes(lowerHindiSign) ||
//               summary.includes(lowerEnglishSign) ||
//               summary.includes(lowerPhoneticSign) || // ✅ NEW: Check phonetic in summary
//               subSubCategory.includes(lowerHindiSign) ||
//               subSubCategory.includes(lowerEnglishSign) ||
//               subSubCategory.includes(lowerPhoneticSign) || // ✅ NEW: Check phonetic in subSubCategory
//               tags.includes(lowerHindiSign) ||
//               tags.includes(lowerEnglishSign) ||
//               tags.includes(lowerPhoneticSign) // ✅ NEW: Check phonetic in tags
//             );
//           });
...
//       })
//       .catch(err => {
//         console.error("Failed to fetch horoscope news:", err); // Better error logging
//         setError("News fetch failed. Please try again.");
//       })
//       .finally(() => setIsLoading(false));
//   }, [selectedSign]); // Dependency array includes selectedSign
...
//             {/* ✅ चेतावनी संदेश को भाषा के अनुसार बदलें */}
